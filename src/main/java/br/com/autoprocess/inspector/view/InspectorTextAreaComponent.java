 ...
 */
public class InspectorTextAreaComponent extends JTextArea {
	...
	public InspectorTextAreaComponent() {
		super();
		initialize();
	}

	public InspectorTextAreaComponent(Document doc, String text, int rows, int columns) {
		super(doc, text, rows, columns);
		initialize();
	}

	public InspectorTextAreaComponent(Document doc) {
		super(doc);
		initialize();
	}

	public InspectorTextAreaComponent(int rows, int columns) {
		super(rows, columns);
		initialize();
	}

	public InspectorTextAreaComponent(String text, int rows, int columns) {
		super(text, rows, columns);
		initialize();
	}

	public InspectorTextAreaComponent(String text) {
		super(text);
		initialize();
	}
	...
	/**
	 * Sobreescreve o m�todo replaceSelection
	 */
	public void replaceSelection(String text) {

		// ---------------------------
		// Implementa o modo sobrescrever, selecionando o caractere na posi��o atual do cursor
		// ---------------------------
		if (isOvertypeMode) {
			int pos = getCaretPosition();
